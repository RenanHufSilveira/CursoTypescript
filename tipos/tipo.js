...
console.log("Tipo da variavel minhaIdade: " + typeof minhaIdade);
//Array
let hobbies = ["Cozinhar", "Academia", "Trabalhar"];
...
let endereco = ["Avenida Brasil", 991, "Casa azul"];
...
var CorComValor;
(function (CorComValor) {
    CorComValor[CorComValor["Cinza"] = 50] = "Cinza";
    CorComValor[CorComValor["Verde"] = 100] = "Verde";
    CorComValor[CorComValor["Azul"] = 101] = "Azul";
    CorComValor[CorComValor["Vermelho"] = 200] = "Vermelho";
})(CorComValor || (CorComValor = {}));
let minhaCorValor = CorComValor.Verde;
